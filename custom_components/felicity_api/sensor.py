...
SENSOR_MAP = {
    ...
    "bmsStateText": SensorEntityDescription(key="bmsStateText", translation_key="bmsStateText"),
    "bmsStateFlags": SensorEntityDescription(key="bmsStateFlags", translation_key="bmsStateFlags"),
    "workMode": SensorEntityDescription(key="workMode", translation_key="workMode"),
    "workModeText": SensorEntityDescription(key="workModeText", translation_key="workModeText"),
    "heatStatus": SensorEntityDescription(key="heatStatus", translation_key="heatStatus"),
    "heatStatusText": SensorEntityDescription(key="heatStatusText", translation_key="heatStatusText"),
    "maxVoltage2bms": _voltage_sensor("maxVoltage2bms"),
    "minVoltage2bms": _voltage_sensor("minVoltage2bms"),
    "cellVoltageDelta": _voltage_sensor("cellVoltageDelta"),
    "maxVoltageNum2bms": SensorEntityDescription(key="maxVoltageNum2bms", translation_key="maxVoltageNum2bms", state_class=SensorStateClass.MEASUREMENT),
    "minVoltageNum2bms": SensorEntityDescription(key="minVoltageNum2bms", translation_key="minVoltageNum2bms", state_class=SensorStateClass.MEASUREMENT),
    "maxCellTempNum": SensorEntityDescription(key="maxCellTempNum", translation_key="maxCellTempNum", state_class=SensorStateClass.MEASUREMENT),
    "minBattTempNum": SensorEntityDescription(key="minBattTempNum", translation_key="minBattTempNum", state_class=SensorStateClass.MEASUREMENT),
    "BMSLCVolt": _voltage_sensor("BMSLCVolt"),
    "BMSLDVolt": _voltage_sensor("BMSLDVolt"),
    "BMSLCCurr": _current_sensor("BMSLCCurr"),
    "BMSLDCurr": _current_sensor("BMSLDCurr"),
    ...
    def native_value(self) -> Optional[Any]:
        ...
        if self._device_kind == "battery":
            battery_key_map = {
                ...
                "emsVoltage": ["battVolt", "emsVoltage"],
                "emsCurrent": ["battCurr", "emsCurrent"],
